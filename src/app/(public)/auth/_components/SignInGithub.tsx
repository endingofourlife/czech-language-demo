...
async function SignInGithub() {
    return (
        <form action={async() => {
            ...
            <button
                type="submit"
                className="mt-4 w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl text-sm text-gray-300 shadow-sm transition-all duration-200 hover:bg-[#252525] hover:border-[#3A3A3A] hover:shadow-md active:scale-[0.97]"
            >
